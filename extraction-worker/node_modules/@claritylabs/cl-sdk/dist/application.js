...
var OperationalProductIdentitySchema = import_zod3.z.object({
...
var OperationalAddressSchema = import_zod3.z.object({
  street1: import_zod3.z.string().optional(),
  street2: import_zod3.z.string().optional(),
  city: import_zod3.z.string().optional(),
  state: import_zod3.z.string().optional(),
  zip: import_zod3.z.string().optional(),
  country: import_zod3.z.string().optional(),
  formatted: import_zod3.z.string().optional()
});
var OperationalDeclarationFactSchema = import_zod3.z.object({
  field: import_zod3.z.enum([
    "namedInsured",
    "mailingAddress",
    "dba",
    "entityType",
  ...
  value: import_zod3.z.string(),
  normalizedValue: import_zod3.z.string().optional(),
  valueKind: import_zod3.z.enum(["string", "number", "date", "money", "address", "list", "unknown"]).default("string"),
...
var OperationalCoverageScheduleValueSchema = import_zod3.z.object({
  label: import_zod3.z.string(),
  value: import_zod3.z.string()
});
var OperationalCoverageScheduleItemSchema = import_zod3.z.object({
  label: import_zod3.z.string(),
  description: import_zod3.z.string().optional(),
  values: import_zod3.z.array(OperationalCoverageScheduleValueSchema).default([]),
  sourceSpanIds: import_zod3.z.array(import_zod3.z.string().min(1)).default([])
});
var OperationalCoverageScheduleSchema = import_zod3.z.object({
  name: import_zod3.z.string(),
  kind: import_zod3.z.enum(["vehicle", "property", "location", "other"]),
  description: import_zod3.z.string().optional(),
  items: import_zod3.z.array(OperationalCoverageScheduleItemSchema).default([]),
  sourceSpanIds: import_zod3.z.array(import_zod3.z.string().min(1)).default([]),
  pageStart: import_zod3.z.number().int().positive().optional(),
  pageEnd: import_zod3.z.number().int().positive().optional()
});
var OperationalPremiumLineSchema = import_zod3.z.object({
  line: import_zod3.z.string(),
  amount: import_zod3.z.string(),
  amountValue: import_zod3.z.number().optional(),
  sourceNodeIds: import_zod3.z.array(import_zod3.z.string().min(1)).default([]),
  sourceSpanIds: import_zod3.z.array(import_zod3.z.string().min(1)).default([])
});
var OperationalTaxFeeItemSchema = import_zod3.z.object({
  name: import_zod3.z.string(),
  amount: import_zod3.z.string(),
  amountValue: import_zod3.z.number().optional(),
...
var PolicyOperationalProfileSchema = import_zod3.z.preprocess(
  ...
  import_zod3.z.object({
    ...
    declarationFacts: import_zod3.z.array(OperationalDeclarationFactSchema).default([]),
    coverages: import_zod3.z.array(OperationalCoverageLineSchema).default([]),
    coverageSchedules: import_zod3.z.array(OperationalCoverageScheduleSchema).optional(),
    premiumBreakdown: import_zod3.z.array(OperationalPremiumLineSchema).optional(),
    taxesAndFees: import_zod3.z.array(OperationalTaxFeeItemSchema).optional(),
