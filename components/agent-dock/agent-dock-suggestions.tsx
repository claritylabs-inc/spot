...
export function AgentDockSuggestions({
  ...
  return (
    <div className="mt-auto pb-2">
      <ul aria-label="Suggested prompts" className="flex flex-col">
        {items.map((item) => (
          <li key={item.id}>
            <button
              type="button"
              ...
              className={cn(
                "flex w-full items-center gap-2.5 rounded-md py-1.5 text-left text-muted-foreground transition-colors hover:text-foreground focus-visible:text-foreground focus-visible:outline-none disabled:opacity-50",
