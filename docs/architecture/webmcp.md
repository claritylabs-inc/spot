...
| Settings › Organization | Name, website, research, logo upload, logo from website | `get_organization`, `update_organization`, `research_company`, `upload_organization_logo`, `import_logo_from_website` |
