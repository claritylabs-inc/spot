...
Live search includes mailbox listing, Gmail search, full thread reads, and original
...
- Gmail remains read-only. Scheduled Spot writes require separate explicit authorization.
