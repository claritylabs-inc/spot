...
registered to the protected operator thread, rendered an authorized link, and
opened through the existing PDF preview. No base64 or public URL reached the
model.
