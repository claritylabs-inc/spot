...
| `create_procurement_file_item`             | Track/link a canonical artifact with explicit release state; released files immediately appear on existing in-scope packet links.                                          | `operator.procurement.write`    | reversible write | operator | exact        | mutation  |
| `update_procurement_file_item`             | Update an artifact association, purpose, status, links, or audience release; existing packet links update immediately.                                            | `operator.procurement.write`    | reversible write | operator | exact        | mutation  |
