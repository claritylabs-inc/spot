...
| `research_client` | Queue or refresh durable official-site research; inspect the persisted outcome before claiming completion. | `operator.organizations.write` | reversible write | operator | exact | mutation |
