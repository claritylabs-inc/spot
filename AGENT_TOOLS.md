...
| `create_procurement_file_item`             | Add a labeled file or file request with independent client/broker visibility; link an underlying file when available, with released files appearing immediately on existing packet links.                                          | `operator.procurement.write`    | reversible write | operator | exact        | mutation  |
| `update_procurement_file_item`             | Update a file label, underlying file link, or client/broker visibility; visibility may be set before upload and released files update existing packet links immediately.                                            | `operator.procurement.write`    | reversible write | operator | exact        | mutation  |
