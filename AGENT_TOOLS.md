...
| `get_routing_status`                       | Read invocation logs, errors, unknown outcomes and route freshness, or exact `callId` metadata; no prompts, response bodies or credentials.                                             | `operator.routing.read`         | read             | operator | none         | mutation  |
