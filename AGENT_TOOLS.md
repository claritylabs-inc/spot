...
| `lookup_procurement_packet`                | Read the named packet Markdown files and their front-matter permissions.                                              | `operator.procurement.read`     | read             | operator | none         | mutation  |
...
| `update_procurement_packet`        | Create or replace a named packet .md file with front-matter visibility and an expected revision.                                                | `operator.procurement.write`    | reversible write | operator | exact        | mutation  |
...
| `update_organization_profile`              | Update identity, legal entities, classification and partial insurance-profile overrides.                                                                   | `operator.organizations.write`  | reversible write | operator | exact        | mutation  |
...
- Shared procurement packet content is identical for clients and broker markets. Operator notes live in a separate private document. Existing issued link snapshots remain immutable. Request intake and market logs use their own Markdown documents rather than competing narrative fields.
